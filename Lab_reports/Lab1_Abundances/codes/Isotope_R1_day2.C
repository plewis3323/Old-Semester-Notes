...
double Eff_L(double x) {
    double a1 = -4.5368e-06 ; 
    double b1 = 0.00100131;
    double c1 =  0.564514 ; 
...
void UR(TString filename, TString histname, TCanvas* Sources1) {
    ...
    TF1 *gausFit3 = new TF1("gausFit3", "gaus", 969, 985); 
    myhist->Fit(gausFit3, "R"); 
    gausFit3->SetLineColor(17);
    gausFit3->Draw("SAME");
    double N_t3 = gausFit3->Integral(969, 985);
    double N_b3 = (myhist->Integral(953, 969) + myhist->Integral(985, 1001)) / 2;
    ...
    // Peak 5: 1460-1475 (U-238)
    TF1 *gausFit5 = new TF1("gausFit5", "gaus", 1460, 1485); 
    myhist->Fit(gausFit5, "R"); 
    gausFit5->SetLineColor(9);
    gausFit5->Draw("SAME");
    double N_t5 = gausFit5->Integral(1460, 1485);
    double N_b5 = (myhist->Integral(1435, 1460) + myhist->Integral(1485, 1510)) / 2;
    ...
    cout << "U-238 Peak 5 total counts (N_t5): " << N_t5 << endl;
    cout << "U-238 Peak 5 background counts (N_b5): " << N_b5 << endl;
    cout << "U-238 Peak 5 signal counts (N_s5): " << N_s5 << endl;
...
UR("UR_day2.xy", "Uranium", c1);
TFile *Ur1 = new TFile("Ur_Run2.root", "RECREATE"); 
c1->Write();
Ur1->Close(); 
