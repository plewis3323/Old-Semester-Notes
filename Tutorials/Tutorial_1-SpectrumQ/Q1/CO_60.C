...
// Create a legend and add entries
    ...
    legend->AddEntry((TObject*)0, "E_{#gamma} = 1173.237 #pm 0.004   keV", "");
    legend->AddEntry((TObject*)0, "E_{#gamma} = 1332.501 #pm 0.005   keV", "");
...
Read_xy_file("germaniumdet_co60.xy", "Co-60");
