...
void Na_22_Resolution(TString filename, TString histname){
...
//Finding the Number of Counnts from Bins 1470-1570: Peak #1
...
Double_t Na_Energies[2] = {510.897, 1274.51};
Double_t Na_Channel_N[2]  = {1511.93, 3840.33};
...
// FWHM = 2.355 * RMS    
// FWHM of Peak #1 where  mean channel = 1511.93
double FWHM_1 = 2.355 * rms1 *a;
cout << "the full width half max of peak #1; FWHM =   " << FWHM_1 << endl; 


// FWHM of Peak #2 where  mean channel = 3840.33
...
// Resolution of Peak #1 where channel = 1511.93
double R_1 = (FWHM_1/Na_Energies[0]) * 100; 
cout << " R_1 =  " << R_1 << "%" <<endl; 


// Resolution of Peak #2 where channel = 3840.33
double R_2 = (FWHM_2/Na_Energies[1]) * 100; 
cout << " R_2 =  " << R_2 << "%" <<endl; 
...
legend->AddEntry((TObject*)0, "#scale[0.8]{E_{#gamma}} = 511.006 #pm 0.0156 keV", "");
legend->AddEntry((TObject*)0, "#scale[0.8]{E_{#gamma}} = 1274.53 #pm 0.0239 keV", "");
...
Na_22_Resolution("germaniumdet_na22.xy", "na_22_histo");
